...
class ContactPageView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.method == "POST" and form.is_valid():
            form.save()
            return HttpResponse("<h2>Biz bilan bog'langaningiz uchun tashakkur</h>")
        context = {
            "form": form
        }
...
class NewsCreateView(OnlyLoggedSuperUser,CreateView):
    ...
    fields = ('title','title_uz', 'title_en', 'title_ru', 'slug', 'body','body_uz', 'body_ru',
              'body_en', 'image', 'category', 'status')
